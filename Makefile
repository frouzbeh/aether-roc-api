...
oapi-codegen-sdn-fabric-0.1.0: # @HELP generate openapi types from sdn-fabric-0.1.0-openapi3.yaml
oapi-codegen-sdn-fabric-0.1.0: oapi-codegen
	mkdir -p pkg/sdn_fabric_0_1_0/types pkg/sdn_fabric_0_1_0/server
	oapi-codegen -generate types -package types -o pkg/sdn_fabric_0_1_0/types/sdn-fabric-0.1.0-types.go api/sdn-fabric-0.1.0-openapi3.yaml
	oapi-codegen -generate spec -package server -o pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-spec.go api/sdn-fabric-0.1.0-openapi3.yaml
	oapi-codegen \
		-generate types,server \
		-import-mapping imp1:"github.com/onosproject/aether-roc-api/pkg/sdn_fabric_0_1_0/types",imp2:"github.com/onosproject/config-models/models/sdn-fabric-0.1.x/api" \
		-package server \
		-templates pkg/codegen/templates \
		-o pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-impl.go \
		api/sdn-fabric-0.1.0-openapi3.yaml
	sed -e "s/externalRef1\./externalRef2./g" pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-impl.go > sdn-fabric-0.1.0-impl.new
	...
	sed -e "s/\"github\.com\/labstack\/echo\/v4\"/\"github.com\/labstack\/echo\/v4\"\n\t\externalRef0 \"github.com\/onosproject\/aether-roc-api\/pkg\/sdn_fabric_0_1_0\/types\"/g" sdn-fabric-0.1.0-server.new1 > sdn-fabric-0.1.0-server.new2
	mv sdn-fabric-0.1.0-server.new2 pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-server.go
	rm sdn-fabric-0.1.0-server.new*
	oapi-codegen \
		-generate types \
		-import-mapping imp1:"github.com/onosproject/config-models/models/sdn-fabric-0.1.x/api" \
		-package server \
		-templates pkg/codegen/convert-oapi-gnmi \
	...
	sed -e "s/\"reflect\"/\"reflect\"\n\t\"github\.com\/onosproject\/aether-roc-api\/pkg\/sdn_fabric_0_1_0\/types\"/g" sdn-fabric-0.1.0-convert-oapi-gnmi.new2 > sdn-fabric-0.1.0-convert-oapi-gnmi.new3
	mv sdn-fabric-0.1.0-convert-oapi-gnmi.new3 pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-convert-oapi-gnmi.go
	rm sdn-fabric-0.1.0-convert-oapi-gnmi.new*
	oapi-codegen \
		-generate types \
		-import-mapping externalRef0:"github.com/onosproject/config-models/models/sdn-fabric-0.1.x/api" \
		-package server \
		-templates pkg/codegen/convert-gnmi-oapi \
		-o pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-convert-gnmi-oapi.go \
		api/sdn-fabric-0.1.0-openapi3.yaml
	sed -e "s/ > !//g" pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-convert-gnmi-oapi.go > sdn-fabric-0.1.0-convert-gnmi-oapi.new
	mv sdn-fabric-0.1.0-convert-gnmi-oapi.new pkg/sdn_fabric_0_1_0/server/sdn-fabric-0.1.0-convert-gnmi-oapi.go
	for f in pkg/sdn_fabric_0_1_0/**/sdn-fabric-0.1.0*.go; do { echo "// Code generated by oapi-codegen. DO NOT EDIT."; cat $$f; } > $$f.new; mv $$f.new $$f; done
